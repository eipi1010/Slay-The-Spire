...
from effects.player_effects import CardEffects, DamageEffect, SelfDiscardEffect, BlockEffect

ironclad_cards = {
    "Strike": Card(name="Strike",mana=1,effects = CardEffects(effects=[DamageEffect(amount=5),SelfDiscardEffect()])),
    "Defend": Card(name="Defend",mana=1,effects=CardEffects([BlockEffect(5)])),
